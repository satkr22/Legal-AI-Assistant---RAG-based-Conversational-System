...
class Phase11Reasoner:
    def __init__(self, corpus_index: CorpusIndex, top_support_hits: int = 4):
...
def main() -> None:
    ...
    reasoner = Phase11Reasoner(corpus_index=corpus_index, top_support_hits=args.top_support_hits)
