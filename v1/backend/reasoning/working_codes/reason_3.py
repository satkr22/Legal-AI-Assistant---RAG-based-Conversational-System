...
class Phase11Reasoner:
    ...
    def reason_one(self, item: Dict[str, Any]) -> Dict[str, Any]:
        ...
        answer = self._build_answer(query, phase8, primary_hit, related_hits, target_summary, intent_alignment, completeness)
